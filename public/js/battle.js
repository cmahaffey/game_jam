...
BedJam.Battle.prototype = {
  init: function(fromState, playerxPos, playeryPos){
    this.fromState = fromState;
    this.playerxPos = playerxPos;
    this.playeryPos = playeryPos;
  },
  create: function() {
    var enemies = BedJam.villains[this.fromState];
    ...
    this.map.addTilesetImage('basictiles', 'gameTilessophie2');
  ...
  update: function() {
    ...
    if (this.game.input.activePointer.justPressed()) {
      this.game.state.start(this.fromState, true, false, this.playerxPos, this.playeryPos);
    }
    //collision
